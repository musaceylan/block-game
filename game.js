...
const TRANSLATIONS = {
    ...
    de: {
        ...
        blockBloom: 'Block Bloom',
        classic: 'Klassisch',
        classicDesc: 'Schlage deinen Highscore',
        dailyPuzzle: 'Tägliches Rätsel',
        dailyDesc: 'Gleiches Rätsel für alle',
        zenMode: 'Zen-Modus',
        zenDesc: 'Entspann dich, kein Druck',
        ...
        totalLines: 'Gesamte Linien',
        piecesPlaced: 'Platzierte Teile',
        ...
        noSpaceRemaining: 'Kein Platz für verbleibende Teile',
        noValidMoves: 'Keine gültigen Züge mehr',
        ...
        of: 'von',
        welcome: 'Willkommen!',
        tutorialDrag: 'Ziehe Blöcke aus der Ablage und lege sie auf das 10×10 Raster.',
        clearLines: 'Linien löschen',
        tutorialClear: 'Fülle eine Reihe oder Spalte vollständig, um sie zu löschen und Punkte zu erhalten!',
        buildCombos: 'Kombos bauen',
        tutorialCombo: 'Lösche Linien nacheinander, um deinen Kombo-Multiplikator zu erhöhen!',
        gotIt: 'Verstanden!',
        next: 'Weiter',
        // Achievements
    ...
    es: {
        ...
        blockBloom: 'Block Bloom',
        classic: 'Clásico',
        classicDesc: 'Supera tu récord',
        dailyPuzzle: 'Puzzle Diario',
        dailyDesc: 'Mismo puzzle para todos',
        zenMode: 'Modo Zen',
        zenDesc: 'Relájate, sin presión',
        ...
        noSpaceRemaining: 'Sin espacio para las piezas restantes',
        noValidMoves: 'No quedan movimientos válidos',
        ...
        of: 'de',
        welcome: '¡Bienvenido!',
        tutorialDrag: 'Arrastra bloques desde la bandeja y suéltalos en la cuadrícula de 10×10.',
        clearLines: 'Eliminar Líneas',
        tutorialClear: '¡Completa una fila o columna para eliminarla y ganar puntos!',
        buildCombos: 'Hacer Combos',
        tutorialCombo: '¡Elimina líneas consecutivamente para aumentar tu multiplicador!',
        gotIt: '¡Entendido!',
        next: 'Siguiente',
        // Achievements
    ...
    fr: {
        ...
        blockBloom: 'Block Bloom',
        classic: 'Classique',
        classicDesc: 'Bats ton meilleur score',
        dailyPuzzle: 'Puzzle du Jour',
        dailyDesc: 'Même puzzle pour tous',
        zenMode: 'Mode Zen',
        zenDesc: 'Détends-toi, sans pression',
        startGame: 'Commencer',
        settings: 'Paramètres',
        // Settings
        ...
        noSpaceRemaining: 'Plus de place pour les pièces restantes',
        noValidMoves: 'Plus de coups possibles',
        playAgain: 'Rejouer',
        menu: 'Menu',
        // Tutorial
        step: 'Étape',
        of: 'sur',
        welcome: 'Bienvenue!',
        tutorialDrag: 'Fais glisser les blocs du plateau et dépose-les sur la grille 10×10.',
        clearLines: 'Effacer les Lignes',
        tutorialClear: 'Remplis une ligne ou colonne pour l\'effacer et marquer des points!',
        buildCombos: 'Faire des Combos',
        tutorialCombo: 'Efface des lignes consécutivement pour augmenter ton multiplicateur!',
        gotIt: 'Compris!',
        next: 'Suivant',
        // Achievements
    ...
    ja: {
        ...
        blockBloom: 'Block Bloom',
        classic: 'クラシック',
        classicDesc: 'ハイスコアを目指せ',
        dailyPuzzle: 'デイリーパズル',
        dailyDesc: 'みんな同じパズル',
        zenMode: 'ゼンモード',
        zenDesc: 'リラックス、プレッシャーなし',
        startGame: 'ゲーム開始',
        settings: '設定',
        // Settings
        soundEffects: '効果音',
        ...
        finalScore: '最終スコア',
        newBest: '新記録！',
        noSpaceRemaining: '残りのピースを置く場所がありません',
        ...
        of: '/',
        welcome: 'ようこそ！',
        tutorialDrag: 'トレイからブロックをドラッグして10×10のグリッドに置きましょう。',
        clearLines: 'ラインを消す',
        tutorialClear: '行や列を完成させて消すとポイントが貰えます！',
        buildCombos: 'コンボを作る',
        tutorialCombo: '連続でラインを消してコンボ倍率を上げよう！',
        gotIt: 'わかった！',
        next: '次へ',
        // Achievements
    ...
    zh: {
        ...
        finalScore: '最终得分',
        newBest: '新纪录！',
        noSpaceRemaining: '没有空间放置剩余方块',
        noValidMoves: '没有有效的移动',
        playAgain: '再玩一次',
        menu: '菜单',
        // Tutorial
        step: '步骤',
        of: '/',
        welcome: '欢迎！',
        tutorialDrag: '从托盘拖动方块并放到10×10的格子上。',
        clearLines: '消除行',
        tutorialClear: '填满一行或一列来消除并获得分数！',
        buildCombos: '创造连击',
        tutorialCombo: '连续消除来提高连击倍数！',
        gotIt: '明白了！',
        next: '下一步',
        // Achievements
    ...
    pt: {
        ...
        blockBloom: 'Block Bloom',
        classic: 'Clássico',
        classicDesc: 'Supere seu recorde',
        dailyPuzzle: 'Puzzle Diário',
        dailyDesc: 'Mesmo puzzle para todos',
        zenMode: 'Modo Zen',
        zenDesc: 'Relaxe, sem pressão',
        ...
        noSpaceRemaining: 'Sem espaço para peças restantes',
        noValidMoves: 'Sem movimentos válidos',
        ...
        of: 'de',
        welcome: 'Bem-vindo!',
        tutorialDrag: 'Arraste blocos da bandeja e solte-os na grade 10×10.',
        clearLines: 'Limpar Linhas',
        tutorialClear: 'Complete uma linha ou coluna para limpá-la e ganhar pontos!',
        buildCombos: 'Fazer Combos',
        tutorialCombo: 'Limpe linhas consecutivamente para aumentar seu multiplicador!',
        gotIt: 'Entendi!',
        next: 'Próximo',
        // Achievements
    ...
    ru: {
        ...
        blockBloom: 'Block Bloom',
        classic: 'Классика',
        classicDesc: 'Побей свой рекорд',
        dailyPuzzle: 'Ежедневная головоломка',
        dailyDesc: 'Одинаковая для всех',
        zenMode: 'Дзен режим',
        zenDesc: 'Расслабься, без давления',
        ...
        noSpaceRemaining: 'Нет места для оставшихся фигур',
        noValidMoves: 'Нет доступных ходов',
        ...
        tutorialDrag: 'Перетащи блоки с панели на сетку 10×10.',
        clearLines: 'Убирай линии',
        tutorialClear: 'Заполни ряд или столбец, чтобы убрать его и получить очки!',
        buildCombos: 'Собирай комбо',
        tutorialCombo: 'Убирай линии подряд, чтобы увеличить множитель!',
        gotIt: 'Понятно!',
        next: 'Далее',
        // Achievements
    ...
    ko: {
        ...
        finalScore: '최종 점수',
        newBest: '신기록!',
        noSpaceRemaining: '남은 조각을 놓을 공간이 없습니다',
        noValidMoves: '유효한 움직임이 없습니다',
        playAgain: '다시 하기',
        menu: '메뉴',
        // Tutorial
        step: '단계',
        of: '/',
        welcome: '환영합니다!',
        tutorialDrag: '트레이에서 블록을 드래그하여 10×10 그리드에 놓으세요.',
        clearLines: '라인 지우기',
        tutorialClear: '행이나 열을 완성하면 지워지고 점수를 얻습니다!',
        buildCombos: '콤보 만들기',
        tutorialCombo: '연속으로 라인을 지워 콤보 배율을 올리세요!',
        gotIt: '알겠어요!',
        next: '다음',
        // Achievements
